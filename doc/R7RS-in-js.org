...
To reduce the code size all the primitives are in [[file:primitive.org::*Vectors][Vectors]].
...
*Gambit*, or at least my version as built, has a string module. I like strings.
But, it also takes a few MB's of code. I dislike that.

So here are the primitives: [[file:primitive.org::#primStr][Strings]].
